...
// upLeft.addEventListener("click", change2);
// downLeft.addEventListener("click", change2);
// upRight.addEventListener("click", change2);
// downRight.addEventListener("click", change2);
